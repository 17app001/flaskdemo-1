...
from pm25 import get_pm25, get_six_pm25, get_county_pm25, six_countys
import json
...
def pm25_charts():
    return render_template("pm25-charts-bulma.html", six_countys=six_countys)


@app.route("/county-pm25-data/<county>", methods=["GET"])
def pm25_county_data(county):
...
@app.route("/six-pm25-data", methods=["POST"])
def six_pm25_data():
    site, pm25 = get_six_pm25()
